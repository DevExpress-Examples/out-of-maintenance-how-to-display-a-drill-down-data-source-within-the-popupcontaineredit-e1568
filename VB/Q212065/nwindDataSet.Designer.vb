...
Namespace Q212065
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class SalesPersonDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddSalesPersonRow(ByVal CategoryName As String, ByVal Sales_Person As String, ByVal UnitPrice As Decimal) As SalesPersonRow
				Dim rowSalesPersonRow As SalesPersonRow = (CType(Me.NewRow(), SalesPersonRow))
				Dim columnValuesArray() As Object = { CategoryName, Sales_Person, UnitPrice}
	...
	End Class
End Namespace
Namespace Q212065.nwindDataSetTableAdapters
	...
	Partial Public Class SalesPersonTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT CategoryName, UnitPrice, [Sales Person] FROM SalesPerson"
