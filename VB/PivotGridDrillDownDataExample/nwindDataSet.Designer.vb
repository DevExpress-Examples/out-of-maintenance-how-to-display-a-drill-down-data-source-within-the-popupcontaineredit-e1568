...
Namespace PivotGridDrillDownDataExample
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class SalesPersonDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Function AddSalesPersonRow(ByVal ProductName As String, ByVal CategoryName As String, ByVal OrderDate As Date, ByVal UnitPrice As Decimal, ByVal Sales_Person As String) As SalesPersonRow
				Dim rowSalesPersonRow As SalesPersonRow = (DirectCast(Me.NewRow(), SalesPersonRow))
				Dim columnValuesArray() As Object = { Nothing, ProductName, CategoryName, OrderDate, UnitPrice, Sales_Person}
	...
	End Class
End Namespace
Namespace PivotGridDrillDownDataExample.nwindDataSetTableAdapters
	...
	Partial Public Class SalesPersonTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT OrderID, ProductName, CategoryName, OrderDate, UnitPrice, [Sales Person] F" & "ROM SalesPerson"
