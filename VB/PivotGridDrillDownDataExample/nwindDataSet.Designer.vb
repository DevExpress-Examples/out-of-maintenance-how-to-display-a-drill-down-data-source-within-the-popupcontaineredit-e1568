...
Partial Public Class nwindDataSet
    ...
    Partial Public Class SalesPersonDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddSalesPersonRow(ByVal ProductName As String, ByVal CategoryName As String, ByVal OrderDate As Date, ByVal UnitPrice As Decimal, ByVal Sales_Person As String) As SalesPersonRow
            Dim rowSalesPersonRow As SalesPersonRow = CType(Me.NewRow,SalesPersonRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, ProductName, CategoryName, OrderDate, UnitPrice, Sales_Person}
...
Namespace nwindDataSetTableAdapters
    ...
    Partial Public Class SalesPersonTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT OrderID, ProductName, CategoryName, OrderDate, UnitPrice, [Sales Person] F"& _ 
                "ROM SalesPerson"
